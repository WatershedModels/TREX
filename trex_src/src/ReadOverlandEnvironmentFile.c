/*---------------------------------------------------------------------
C-  Function:   ReadOverlandEnvironment.c
C-
C-  Purpose\    ReadOverlandEnvironmentFile is called to read the cell
C-  Methods:    values for overland environmental properties for each
...
void ReadOverlandEnvironmentFile(int pid, int ilayer, float conv, float scale)
{
	...
	float
		envvalue;	//value of environmental property

	//write message to screen
	printf("\n\n***************************************************\n");
	printf(	   "*                                                 *\n");
	printf(	   "*   Reading Overland Environmental Property File  *\n");
	printf(	   "*                                                 *\n");
	printf(	   "***************************************************\n\n\n");
	...
	for(i=1; i<=gridrows; i++)
	{
		...
		for(j=1; j<=gridcols; j++)
		{
			...
			if(imask[i][j] > 0)
			{
				...
				envov[pid][i][j][ilayer] = envvalue * conv * scale;
