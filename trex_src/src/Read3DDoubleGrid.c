/*---------------------------------------------------------------------
C-  Function:   Read3DDoubleGrid.c
C-
C-  Purpose/    Read3DDoubleGrid is called at the start of the
C-  Methods:    simulation to read initial condition real (double)
...
void Read3DDoubleGrid(char name[], double ***gridvalue, int ilayer)
{
